...
const CommentArea = ({ bookId }) => {
  ...
  const [setCommentToModify] = useState(null);
  ...
  const getData = async () => {
    ...
    try {
      const response = await fetch(
        `${import.meta.env.VITE_SERVER_BASE_URL}/book/${id}`
      );
  ...
  const handleAdd = async () => {
    ...
    try {
      const response = await fetch(
        `${import.meta.env.VITE_SERVER_BASE_URL}/books/${id}/create/comment`,
        {
          method: "POST",
          headers: {
  ...
  const handleModify = async (id) => {
    ...
    try {
      const response = await fetch(
        `${import.meta.env.VITE_SERVER_BASE_URL}/books/${id}/comment`,
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
